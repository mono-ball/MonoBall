...
This document describes the event-driven architecture design for MonoBall Framework's Arch ECS implementation. The goal is to decouple systems, enable modding, and provide a clean scripting interface while maintaining high performance.
