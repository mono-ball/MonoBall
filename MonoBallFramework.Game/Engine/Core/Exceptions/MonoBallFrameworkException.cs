...
namespace MonoBallFramework.Game.Engine.Core.Exceptions;

/// <summary>
///     Base exception for all MonoBall Framework-specific exceptions.
...
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="MonoBallFrameworkException" /> class.
    /// </summary>
    /// <param name="errorCode">The error code identifying the exception type.</param>
    /// <param name="message">The error message.</param>
    protected MonoBallFrameworkException(string errorCode, string message)
        : base(message)
    {
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="MonoBallFrameworkException" /> class with an inner exception.
    /// </summary>
    /// <param name="errorCode">The error code identifying the exception type.</param>
    /// <param name="message">The error message.</param>
    /// <param name="innerException">The inner exception that caused this exception.</param>
    protected MonoBallFrameworkException(string errorCode, string message, Exception innerException)
    ...
    public MonoBallFrameworkException WithContext(string key, object value)
    {
        Context[key] = value;
        return this;
    }
    ...
    /// <returns>This exception instance for method chaining.</returns>
    public MonoBallFrameworkException WithContext(IDictionary<string, object> contextData)
    {
