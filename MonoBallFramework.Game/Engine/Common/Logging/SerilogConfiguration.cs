...
/// <summary>
///     Provides centralized Serilog configuration for the MonoBall Framework engine.
/// </summary>
public static class SerilogConfiguration
{
    ...
    )
    {
        ...
        else
        {
            ...
            loggerConfig
                ...
                .Enrich.WithProperty("Application", "MonoBall Framework");
            ...
            loggerConfig.WriteTo.Async(a =>
                a.File(
                    $"logs/monoball-{environment.ToLowerInvariant()}-.log",
    ...
    )
    {
        IConfigurationBuilder configBuilder = new ConfigurationBuilder()
            ...
            .AddEnvironmentVariables("MONOBALLFRAMEWORK_");
