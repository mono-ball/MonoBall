...
public class VorbisReader : ISeekableSampleProvider, IDisposable
{
    ...
    public VorbisReader(string filePath)
    {
        ...
        _format = new AudioFormat(_reader.SampleRate, _reader.Channels, 32, true);
    }
    ...
    /// </summary>
    public long TotalSamples => _reader.TotalSamples * _format.Channels;
    ...
    public long Position
    {
        get
        {
            lock (_readLock)
            {
                ...
                return _reader.SamplePosition * _format.Channels;
            }
        }
    }
    ...
    public void SeekToSample(long samplePosition)
    {
        lock (_readLock)
        {
            ...
            long perChannelPosition = samplePosition / _format.Channels;
