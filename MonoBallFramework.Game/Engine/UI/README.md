# MonoBall Framework.Engine.UI.Debug
...
`MonoBall Framework.Engine.Debug`:
...
This framework runs **side-by-side** with the existing `MonoBall Framework.Engine.Debug` console:
...
- MonoBall Framework.Engine.Common
- MonoBall Framework.Engine.Scenes

## License

Same as parent project (MonoBall Framework).
