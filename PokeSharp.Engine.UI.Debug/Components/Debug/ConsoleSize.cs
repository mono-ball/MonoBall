...
public static class ConsoleSizeExtensions
{
    ...
    /// </summary>
    public static float GetHeightPercent(this ConsoleSize size)
    {
        return size switch
        {
    ...
    /// </summary>
    public static ConsoleSize Next(this ConsoleSize size)
    {
        return size switch
        {
    ...
    /// </summary>
    public static ConsoleSize Previous(this ConsoleSize size)
    {
        return size switch
        {
